...
def find_merger_from_swallowing_events(swallowIdx):
    """search for the swallowed BH given a swallow event index

    Args:
        swallowIdx (int): idx in the data where the acBHMass > 0 occurs
    ...
    zmerge = redshift_ds[idx1] # the redshift where acBHMass >0, note the mass is already added
